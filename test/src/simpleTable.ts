...
import {parseToCurrentPageSpec, hash} from "../../js/pageSpec.js";
...
const rowIdResult = {
  "kind": "fusiontables#sqlresponse", "columns": ["rowid"], "rows": [["2"], ["3"], ["4"]]
};

parseToCurrentPageSpec(hash({tableId: table.tableId}));
drawPage(setCurrentViewModelToTable({result: table} as Response<Table>,
    {result: rowResult} as Response<Sqlresponse>, {result: rowIdResult}as Response<Sqlresponse>));