 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const A=new class{handleAttributeExpressions(e,t,n){const i=t[0];return"."===i?new T(e,t.slice(1),n).parts:"@"===i?[new E(e,t.slice(1))]:"?"===i?[new V(e,t.slice(1),n)]:new _(e,t,n).parts}handleTextExpression(e){return new N(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const P=(e,...t)=>new x(e,t,"html",A),j={editable:!1,keydown(){},render(e){const t=/^(.*)\b([01][\w-]{34,42})\b(.*)$/.exec(e);return t?P`${t[1]}<a href=${s({tableId:t[2]})}>${t[2]}</a>${t[3]}`:e}};let C=-1;function F(e){return P`
    <table class="pure-table pure-table-bordered">
	   <thead>
       <tr>${e.tableHead.map(function(t){const n=e=>s(Object.assign({},i,{orderBy:`'${t}' ${e}`})),o=i.tableId?["pure-menu-item"]:["hidden"],r=function(e){return e&&e.column===t?e:void 0}(e.filterEditor);return P`
<td class=${["pure-menu-item","pure-menu-has-children",r?"pure-menu-active":"pure-menu-allow-hover"].join(" ")}>
  <span class="pure-menu-link">${t}</span>
	<ul class="pure-menu-children" @keydown=${function(e){r&&"Enter"===e.key&&r.onDone()}} 
	  ...
	  ${r?function(e){return P`<li class="pure-menu-item"><input type="text" @input=${function(t){e.filterSearch=t.target.value,z()}}></li>`}(r):""}
     ...
     <tbody>
       ${e.tableBody.map(function(t,n){const{editable:i,keydown:s,render:o}=n===C?function({tableBody:e,onRowChanged:t,redrawPage:n}){return{editable:!0,keydown:function(i){if("Escape"===i.code)C=-1,n();else if("Enter"===i.code){const s=i.target,o=s.closest("tr").cells,r=e[C];for(let e=o.length;--e>=0;)r[e]=o.item(e).textContent;t&&t(C),C=-1,n()}},render:e=>e}}(e):j;return P`<tr @dblclick=${function(t){C=n,e.redrawPage(),t.target.focus()}}>${t.map(e=>(function(e){return P`<td contenteditable=${i} @keydown=${s}>${o(""+e)}</td>`})(e))}</tr>`})}
     </tbody>
    </table>`}const L={heading:"Editable FT",menu:[{item:"About",link:"https://github.com/friends-of-fusion-tables/editable-ft"},{item:"Show tables",link:"#"}],tableHead:[],tableBody:[],editFilterLink:()=>"#",routeToPage:e=>window.location.hash=s(e),redrawPage:()=>D(B)},M=Object.assign({},L,{subtitle:"Loading..."}),q=Object.assign({},L,{title:"Authorization required",action:{text:"Authorize",click:()=>gapi.auth2.getAuthInstance().signIn()}});let B=M;function R(e,{columns:t,rows:n}){return e.tableHead=t||[],e.tableBody=n||[],e}let W=!1;function D(e){const t=e.action?function({text:e,click:t}){return P`<button class="pure-button pure-button-primary" @click=${t}>${e}</button>`}(e.action):F(e);function n(){W=!W,e.redrawPage()}I(P`<div id="layout" class=${H("")}>
...
`,document.body)}const H=e=>W?e+" active":e;const z=()=>D(B);gapi.load("client:auth2",()=>{gapi.client.init({apiKey:"AIzaSyAXtETV2s9eaSPC06WVCW3u1eZku0Uh8ic",discoveryDocs:["https://people.googleapis.com/$discovery/rest?version=v1","https://www.googleapis.com/discovery/v1/apis/fusiontables/v2/rest"],clientId:"340312358145-7kum53te698am4dlopel4ea6j8fqqq79.apps.googleusercontent.com",scope:["profile https://www.googleapis.com/auth/fusiontables","https://www.googleapis.com/auth/fusiontables.readonly"].join(" ")}).then(()=>{gapi.auth2.getAuthInstance().isSignedIn.listen(Z),Z(gapi.auth2.getAuthInstance().isSignedIn.get())})});const Z=e=>e?J(location.hash):D(q);function J(e){D(function(e){const{tableId:t,limit:n,orderBy:o,addFilter:r}=e;if(t){const a=l(),u=o?" order by "+o:"";return async function(e,t){const[n,o,a,u]=await Promise.all([gapi.client.fusiontables.table.get({tableId:e}),c("select * "+t),c("select ROWID "+t),function(){const t=l(r);return r?c(`select '${r}', count() from ${e}${t} group by '${r}'`):{}}()]);function c(e){return gapi.client.fusiontables.query.sql({sql:e})}D(function({name:e,description:t,tableId:n},o,r,l,a,u=L){const c=l?function(e){const t=i.filter||{},n=t[e]||[],s=a.rows.map(function(e){const t=""+e[0],i=n.includes(t);return{value:t,count:e[1],selected:i}});return{column:e,filterSearch:"",onDone:function(){const n=s.filter(e=>e.selected).map(e=>e.value);n.length?t[e]=n:delete t[e],Object.keys(t).length?i.filter=t:delete i.filter,delete i.addFilter,u.routeToPage(i)},get filter(){const e=new RegExp(this.filterSearch,"i");return s.filter(t=>e.test(t.value)).slice(0,20)}}}(l):void 0,d=Object.assign({},u,{title:e,subtitle:t,filterEditor:c,onRowChanged:function(e){const t=d.tableBody[e],i=r.rows[e][0],s=`update ${n} set ${d.tableHead.map((e,n)=>`'${e}' = '${t[n]}'`).join(", ")} where rowid = ${i}`;gapi.client.fusiontables.query.sql({sql:s}).execute(e=>console.debug("After "+s+": "+JSON.stringify(e)))},editFilterLink:function(e){return s(Object.assign({},i,{addFilter:e}))}});return B=R(d,o)}(n.result,o.result,a.result,r,r?u.result:void 0))}(t,`from ${t}${a}${u} limit ${n||30}`),M;function l(t){const n=function(e,t=""){return e?Object.keys(e).filter(e=>e!==t).map(function(t){const n=e[t];return 1===n.length?`'${t}' = '${n[0]}'`:`'${t}' in (${n.map(e=>`'${e}'`).join(",")})`}):[]}(e.filter,t);return n.length?" where "+n.join(" and "):""}}return async function(){const e="show tables",t=await gapi.client.fusiontables.query.sql({sql:e});D(function(e,t,n=L){return B=R(Object.assign({},n,{subtitle:e}),t)}(e,t.result))}(),M}(o(e)))}window.addEventListener("hashchange",()=>J(location.hash)),D(B)}]);