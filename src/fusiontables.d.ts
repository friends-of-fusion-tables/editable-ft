/**
 * Copied from npm module @types/gapi.client.fusiontables with correction for
 * issue #3 https://github.com/Bolisov/google-api-typings-generator/issues/3.
 */
...
declare namespace gapi.client {
  ...
  /**
   * Loads the client library interface to a particular API. The new API
   * interface will be in the form gapi.client.api.collection.method.
   * @param name The name of the API to load.
   * @param version The version of the API to load
   * @param callback the function that is called once the API interface is
   *     loaded
   */
  ...
  function request<T>(args: {
    ...
    //  gapi.client.HttpRequest object is returned
    //  */
    // callback?: () => any;
  }): Request<T>;
  ...
  /**
   * An object encapsulating an HTTP request. This object is not instantiated
   * directly, rather it is returned by gapi.client.request.
   */
  interface Request<T> extends PromiseLike<Response<T>> {
    /**
     * Executes the request and runs the supplied callback on response.
     * @param callback The callback function which executes when the request
     *     succeeds or fails.
     */
    execute(
        callback: (/**
                    * contains the response parsed as JSON. If the response is
                    * not JSON, this field will be false.
                    */
    ...
    add<T>(request: Request<T>, opt_params?: {
      ...
      id: string; callback(                                 /**
                           ...
                           individualResponse: Response<T>, /**
                                                             * is the raw batch ID-response map as a
                                                             * string. It contains all responses to
                                                             * all requests in the batch.
                                                             */
                           rawBatchResponse: string): any
    }): void;
    /**
     * Executes all requests in the batch. The supplied callback is executed on
     * success or failure.
  ...
  namespace fusiontables {
    ...
    interface Column {
       ...
       * DT_MONTH_DAY_4_DIGIT_YEARfor example 12/24/2008 DT_TIME_LONGfor example
       * 8:30:45 PM UTC-6 DT_TIME_MEDIUMfor example 8:30:45 PM DT_TIME_SHORTfor
       * example 8:30 PM DT_YEAR_ONLYfor example 2008
    ...
    interface Template {
       ...
       * certain tags, e.g., script. Only one of body or automaticColumns can be
       * specified.
       */
      body?: string;
      /**
    ...
    interface QueryResource {
      ...
      sql(request: {
        ...
        sql: string;
        /**
           Whether typed values are returned in the (JSON) response: numbers
      ...
      sqlGet(request: {
        ...
        fields?: string;
        /**
           Whether column names are included (in the first row). Default is
           true.
         */
        hdrs?: boolean;
        /**
    ...
    interface TableResource {
      ...
      importRows(request: {
        ...
        alt?: string;
        /**
           The delimiter used to separate cell values. This can only consist of
        ...
        encoding?: string;
        /**
         * The index of the line up to which data will be imported. Default is
         * to import the entire file. If endLine is negative, it is an offset
         * from the end of the file; the imported content will exclude the last
         * endLine lines.
         */
        endLine?: number;
        /**
        ...
        quotaUser?: string;
        /**
           The index of the first line from which to start importing,
    ...
    interface TemplateResource {
      ...
      list(request: {
        ...
        oauth_token?: string;
        /**
           Continuation token specifying which results page to return.
           Optional.
         */
        pageToken?: string;
        /** Returns response with indentations and line breaks. */
